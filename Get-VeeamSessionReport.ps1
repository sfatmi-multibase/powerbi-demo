...
function Get-VeeamSessionReport {
  ...
  begin {
    ...
    if (!(Get-PSSnapin -Name VeeamPSSnapIn -ErrorAction SilentlyContinue)) {
	  ...
	  Import-Module Veeam.Backup.PowerShell   #Sameer
	  Disconnect-VBRServer		#Sameer
  ...
  process {
	...
	$VMwareBackupJobIDs = $AllJobs  #Sameer
	...
	#$SelectTaskSessions = $SelectBackupSessions      #Sameer
